...
\frame{
\textbf{Goal}:
\todo{Use \texttt{RNAcode} to predict coding sequences in a MAF alignment.}

\todo{not installed yet}

\begin{itemize}
\item Upload the file \texttt{oskar.27way.rnacode.maf} into your Galaxy session.
\item \todo{Change its data type to maf}
...
\todo{-d and -m are both activated by default}
